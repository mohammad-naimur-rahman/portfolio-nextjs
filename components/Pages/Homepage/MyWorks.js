...
export const projects = [
  {
    id: 1,
    screenshot: '/images/tavelGuru.jpg',
    ...
    tools: ['React', 'react router', 'firebase auth', 'express', 'mongodb', 'react-bootstrap', 'heroku'],
  ...
  {
    id: 2,
    screenshot: '/images/madReaders.jpg',
  ...
  {
    id: 3,
    screenshot: '/images/restaurant.jpg',
    name: 'Restaurant website landing page',
    features:
      'A simple fully responsive static landing page. And used no framework to design the site. All necessary features in one page',
    tools: ['HTML', 'pure CSS', 'SCSS', 'JavaScript', 'Github pages'],
  ...
  {
    id: 5,
    screenshot: '/images/doctorsPortal.jpg',
  ...
  return (
    <section className='p-2 p-md-5'>
      ...
      <div className='text-center pb-3'>
        <Link href='/projects'>
          <button className='primary-btn'>All of my works</button>
        </Link>
      </div>
    </section>
  )
